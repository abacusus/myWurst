...
@SearchTags({"better trigger", "trigger bot", "axe", "crit"})
public final class BetterTriggerHack extends Hack
	implements PreMotionListener, HandleInputListener
{
	...
	private final CheckboxSetting attackWhileBlocking = new CheckboxSetting(
		"Attack while blocking", "Attacks even while using items.", false);
	
	private final CheckboxSetting simulateMouseClick = new CheckboxSetting(
		"Simulate mouse click", "Simulates an actual mouse click.", false);
	...
	public void onHandleInput()
	{
		...
		/*
		 * On ground → normal TriggerBot
		 * In air → only attack while FALLING
		 */
